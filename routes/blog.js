...
// });
// We need to outsource this function to post-controllers.js file.
// These kind of functions are the ones that are known as controllers.
router.get("/", blogControllers.getHome);
// We don't execute the function like blogControllers.getHome()
// Instead, Express.js should execute it for us whenever we got a incoming request.
// ============================================================================================================
